...
<div class=" exams" style="width:95%;margin:auto">
    <div class="w3-text-white">
        <h1 class="w3-margin-0 w3-row">
                ...
                <div class="w3-row">
                    <div  class="">
                        <div class="">
                            ...
                            <b id="classname" class="w3-small">{{$class->name}}</b>
                        </div>
                        
                    </div>
                    
                    <div class="w3-tiny w3-margin-top">
                        <button class='w3-white w3-border w3-border-grey w3-card w3-tiny' style="width:33%;white-space: normal;word-wrap: break-word;" onclick="attendance.showClassAttencanceModal('{{$class->ID}}','Daily')"> Take Attendance</button>
                        <button class='w3-white w3-border w3-border-grey w3-card w3-tiny' style="width:33%;" onclick="attendance.showClassAttencanceModal('{{$class->ID}}','Daily')"> Exams & Tests</button>
                        <button class='w3-white w3-border w3-border-grey w3-card w3-tiny' onclick="stdclass.showClassHWModal()"> Homeworks</button>
                    </div>
                </div>
                
                
                <h2 class="bluefont w3-row w3-hide-small">
        ...
        <div class="w3-rest" style="width:100%">
            ...
            <div id="tabcontainer" init="1">
                <div class="w3-twothird" style="">
                    <h6 class="w3-row">
                        <b class="">{{$class->abbr}} Students</b>
                        <div class="w3-row w3-red">
                            <button class='w3-third w3-btn w3-small w3-round-large'  onclick="document.getElementById('newStudentModal').style.display = 'block'">+ Create New Student</button>
                            <button class='w3-half w3-btn w3-small w3-round-large'  onclick="document.getElementById('editStudentsModal').style.display = 'block'">Edit Students</button>
                        </div>
                    </h6>
                    <div class="w3-white w3-border w3-margin-0" style="">
    
                        <ul id="studentlist" class="exams w3-light-gray" style="padding: 0px;margin:0px">
                            @foreach ($classstudents as $std)
                            <li id="{user_id}" class="w3-white" style="margin: 5px;padding:0px;">
                                <div class="exam w3-row">
        						    <input stdid='{studentid}' class="w3-left w3-hide-small w3-margin-top w3-margin-right stdlistcbx" onclick="stdclass.stdselectCBX()" type="checkbox" />
        							...
        							<div class="w3-left w3-hide-large w3-hide-small">
    ...
    <div class="w3-container">
      ...
      <div id='classAttModalCont'>
        <div class='w3-row w3-tiny w3-text-grey'>
            ...
            <div class='w3-left  w3-padding' id='camrc'>
                
                <h2 class="w3-row">
                    <table>
                        <tr>
                            <td>
                                <b class="redfont w3-left w3-border-bottom w3-margin-bottom w3-margin-right">{{$class->abbr}}</b>
                            </td>
                            <td>
                                <span class="w3-large w3-right" style='word-wrap: break-word;'> Attendance Register</span>
                            </td>
                        </tr>
                    </table>
                ...
                <div class='w3-margin-right w3-margin-bottom'>
                    ...
                    <input type='date' class='w3-small w3-input w3-border' id="attendanceDate" value="{date}" onchange="stdclass.loadClassAttendance({{$class->ID}})" />
                ...
                <div class="w3-margin-bottom">
                    <ul id="classAttendanceStdList" class="w3-ul">
                        ...
                        <li class="w3-row w3-margin-bottom" style="padding:0;padding-bottom:5px;">
                            <div class="w3-left w3-small">
                            {{$cta->stdname}}
                            </div>
                            <button id="{{$cta->user_id}}" class="w3-button attstatusbtn w3-right w3-margin-left {{$cta->attstatuscolor}} w3-card w3-round w3-small" onclick="attendance.statusBTN(this)">{{$cta->attstatus}}</button>
                ...
                <div class="w3-padding w3-black w3-center" style="position: fixed;bottom:0;left:0;width:100%">
                    
                    <button class="w3-btn  w3-card w3-round bluetheme w3-small"
...
<!-- Exam List Modal -->
<div id="newStudentModal" class="w3-modal" style="padding:0px">
    <div class="w3-modal-content w3-light-gray">
        <div class="w3-container">
            ...
            <div class="">
                ...
                <div class='w3-white w3-margin-0' id="">
                    <div class="w3-margin-0" id="newStudentsFormSingle">
						<div class='{bits}'id="bits" style='display:none;'></div>
